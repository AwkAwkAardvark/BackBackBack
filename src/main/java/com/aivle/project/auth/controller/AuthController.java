...
public class AuthController {
	...
	public ResponseEntity<com.aivle.project.common.dto.ApiResponse<AuthLoginResponse>> login(
		...
		return ResponseEntity.ok()
			...
			.body(com.aivle.project.common.dto.ApiResponse.ok(response));
	}
	...
	public ResponseEntity<com.aivle.project.common.dto.ApiResponse<TokenResponse>> refresh(
	...
	public ResponseEntity<com.aivle.project.common.dto.ApiResponse<SignupResponse>> signup(
			@Valid @RequestBody SignupRequest request,
			@Parameter(hidden = true) HttpServletRequest httpServletRequest) {
		String clientIp = resolveIp(httpServletRequest);
		return ResponseEntity.status(HttpStatus.CREATED)
			.body(com.aivle.project.common.dto.ApiResponse.ok(signUpService.signup(request, clientIp)));
	}
